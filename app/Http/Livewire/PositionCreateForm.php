...
class PositionCreateForm extends Component
{
    ...
    public function savePositions()
    {
        ...
        ], ['positions.0.name.required' => 'Setidaknya input Kelas / Jurusan pertama wajib diisi.']);
        ...
        redirect()->route('positions.index')->with('success', 'Data Kelas / Jurusan berhasil ditambahkan.');
    }
